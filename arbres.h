...
/* Un arbre binaire est défini comme une référence vers le noeud racine de
 * l'arbre. Un arbre binaire vide est représenté par une référence NULL. Un
 * arbre binaire est une structure de données récursive. Si il n'est pas vide,
 * ses fils sont des arbres.
 */
typedef noeud *arbre;
